    ...
    switch (hit_object->type) {
        ...
        case nc_slider: {
            ...
            for (int j = 0; j < hit_object->ho.slider.num_curve; j++) {
                ...
                char *buffer_curve = malloc(len_buffer_curve * sizeof(*buffer_curve));
...

            {
                ...
                char *buffer_sl = malloc(len_buffer_sl * sizeof(*buffer_sl));
            ...
            if (hit_object->ho.slider.edge_sounds != NULL || hit_object->ho.slider.num_edge_sound > 0) {
                for (int j = 0; j < hit_object->ho.slider.num_edge_sound; j++) {
                    ...
                    char *buffer_edge_sound = malloc(len_edge_sound * sizeof(*buffer_edge_sound));
            ...
            if (hit_object->ho.slider.edge_sounds != NULL || hit_object->ho.slider.num_edge_sound > 0) {
                for (int j = 0; j < hit_object->ho.slider.num_edge_set; j++) {
                    ...
                    char *buffer_edge_set = malloc(len_edge_set * sizeof(*buffer_edge_set));
